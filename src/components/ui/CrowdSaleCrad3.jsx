...
export default function FinishedCrowdsaleCard({ contractAddress }) {
  ...
  if (details && status && status !== "Finished") {
    return null;
  }
    ...
    >
      ...
      <div className="mb-4">
        <input
          ...
          placeholder="Enter contribution (POL)"
        />
      </div>
